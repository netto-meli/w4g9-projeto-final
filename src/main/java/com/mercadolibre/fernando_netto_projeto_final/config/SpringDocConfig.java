...
import static com.mercadolibre.fernando_netto_projeto_final.util.ScopeUtils.getScopeValue;
import static com.mercadolibre.fernando_netto_projeto_final.util.ScopeUtils.isLocalScope;
  ...
  public OpenAPI customOpenAPI(
    ...
    Info info = new Info()
        ...
        .contact(
            new Contact()
                .name("fernando netto")
                .email("fernando.netto@mercadolivre.com"));
