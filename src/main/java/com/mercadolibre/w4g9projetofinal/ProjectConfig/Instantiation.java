...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Seller s1 = new Seller(null, "Marcos Sá", "email1@hotmail.com", pe.encode("123456"));
        Seller s2 = new Seller(null, "Felipe Bontempo", "email2@hotmail.com", pe.encode("123456"));
        Seller s3 = new Seller(null, "Fernando Netto", "email3@hotmail.com", pe.encode("123456"));
        Seller s4 = new Seller(null, "Leonardo", "email4@hotmail.com", pe.encode("123456"));
        Seller s5 = new Seller(null, "Rafael Menezes", "email5@hotmail.com", pe.encode("123456"));
        sellerRepository.saveAll(Arrays.asList(s1, s2, s3, s4, s5));

        Representative r1 = new Representative(null, "Marcos Sá", "email1@gmail.com", RepresentativeJob.LIDER, pe.encode("151515"));
        Representative r2 = new Representative(null, "Marcos Sá", "email2@gmail.com", RepresentativeJob.SUPERVISOR, pe.encode("151515"));
        ...
        Buyer b2 = new Buyer(null, "Ricardo oo", "email2@yahoo.com", pe.encode("123"), "qnp28conjuntoU");
        Buyer b3 = new Buyer(null, "Ricardo oo", "email3@yahoo.com", pe.encode("123"), "qnp28conjuntoU");
        Buyer b4 = new Buyer(null, "Ricardo oo", "email4@yahoo.com", pe.encode("123"), "qnp28conjuntoU");
        Buyer b5 = new Buyer(null, "Ricardo oo", "email5@yahoo.com", pe.encode("123"), "qnp28conjuntoU");
